...
```{figure} images/interview.svg
:alt: A stylized illustration of a person at a laptop with a microphone, recording an interview.
:figwidth: 70%
:align: center
...
```{figure} images/interview_dark.svg
:alt: A stylized illustration of a person at a laptop with a microphone, recording an interview.
:figwidth: 70%
:align: center
:class: fig-caption-text
